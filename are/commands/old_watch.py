...
# are/commands/old_watch.py
# 这是原始的 watch 命令，用于保持向后兼容性
...
class OldWatchCommand(CommandBase):
    """进程观察命令"""

    name = "watch"
    help_short = "Watch and attach to a process (legacy)"
    help_text = """Watch and attach to a process to establish a Frida session for hooking (legacy command)
    
    这是原始的 watch 命令，用于保持向后兼容性。
    推荐使用新的 watching 命令，它提供了更多功能。
    """
    ...
    def execute(self, context: Any, args: str):
        ...
        参数:
            ...
            args: 命令参数
        """
        console.info("注意: 'watch' 是旧命令，推荐使用 'watching' 命令以获取更好的体验")
        ...
        try:
            ...
            console.info("建议切换到新的 'watching' 命令以获得更好的体验")
